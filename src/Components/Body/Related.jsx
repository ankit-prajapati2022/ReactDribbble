        ...
        <div class="content-wrapper">
          <div class="news-card">
            ...
            <div class="news-card__text-wrapper">
              ...
              <div class="news-card__details-wrapper DriAction">
                <div>
                  <a href="#" class="driPink-btn">
                    <svg
          ...
          <div class="news-card">
            ...
            />
            <div class="news-card__text-wrapper">
              <h2 class="news-card__title">Amazing Second</h2>
              <div class="news-card__details-wrapper DriAction">
                <div>
                  <a href="#" class="driPink-btn">
                    <svg
          ...
          <div class="news-card">
            ...
            />
            <div class="news-card__text-wrapper">
              <h2 class="news-card__title">Amazing Forth</h2>
              <div class="news-card__details-wrapper DriAction">
                <div>
                  <a href="#" class="driPink-btn">
                    <svg
