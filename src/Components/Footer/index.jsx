...
const Index = () => {
  return (
    <div className="DriFooter-main">
      <div className="DriFooter-container">
        <div className="DriFootCon-upper">
          <div>
            <a href="#">
              <svg
            ...
            <div>
              <div class="DriFooter-icons">
                ...
                <a href="#">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    aria-labelledby="aer9a85yzi6yxrihkmyb8sqwt3zr37zz"
                    role="img"
                    viewBox="0 0 24 24"
                    class="icon fill-current"
                  >
                    <title id="aer9a85yzi6yxrihkmyb8sqwt3zr37zz">
                      Twitter icon
                    </title>
                ...
                <a href="http://facebook.com/dribbble">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    aria-labelledby="abe703k8wvox6aoxiaz7q6na0xpyq5h"
                    role="img"
                    viewBox="0 0 24 24"
                    class="icon fill-current"
                  >
                    <title id="abe703k8wvox6aoxiaz7q6na0xpyq5h">
                      Facebook icon
                    </title>
                ...
                <a href="http://www.pinterest.com/dribbble/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    aria-labelledby="affp40tiiz671277rxqlcmtthfdmrkiv"
                    role="img"
                    viewBox="0 0 24 24"
                    class="icon fill-current"
                  >
                    <title id="affp40tiiz671277rxqlcmtthfdmrkiv">
                      Pinterest icon
                    </title>
          ...
          <div className="DriFoot-upper--links">
            <div className="DriFoot-upper--links--list">
        ...
        <div className="DriFootCon-lower">
          <div>© 2022 Dribbble. All rights reserved.</div>
          <div className="DriFootCon-lower-container">
            <div>
              <span class="shots-count">19,747,860</span>
              shots dribbbled
            </div>
            <img
              class="ball"
